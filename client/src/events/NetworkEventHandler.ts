...
import { UpdateEvent } from "../../../common/src/events/server/UpdateEvent";
...
export class NetworkEventHandler {
    ...
    private static eventHandlers = {
        ...
        [ServerEventType.update]: (game: ClientGame, event: UpdateEvent): void => {
            //game.updateObject(event.data.id, event.data.property, event.data.value);
        },
    }
}