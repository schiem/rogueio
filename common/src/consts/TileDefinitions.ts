...
export const TileDefinitions: Record<TileName, TileDefinition> = {
    ...
    [TileName.constructedRubble]: { name: 'constructedRubble', movement: [], sprite: { name: SpriteName.rubble, color: SpriteColor.default }, blocksVision: true },
    [TileName.naturalRubble]: { name: 'naturalRubble', movement: [], sprite: { name: SpriteName.rubble, color: SpriteColor.brown }, blocksVision: true },
};
